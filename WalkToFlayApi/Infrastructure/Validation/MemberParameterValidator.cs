...
namespace WalkToFlayApi.Infrastructure.Validation
{
    ...
    /// MemberParameter參數驗證
    /// </summary>
    public class MemberParameterValidator : AbstractValidator<MemberParameter>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberParameterValidator"/> class.
        /// </summary>
        public MemberParameterValidator()
        {
            RuleFor(x => x.MemberId)
                ...
                .WithMessage("帳號不能為空")
                .Matches("^[A-Za-z0-9]+$")
                .WithMessage("帳號只能輸入英文及數字")
                .MinimumLength(8)
                .WithMessage("帳號長度不能小於8")
                .MaximumLength(20)
                .WithMessage("帳號長度不能超過20");
